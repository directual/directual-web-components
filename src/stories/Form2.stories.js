        ...
        "steps": [
            {
                ...
                "elements": [
                    {
                        "id": "elmnt_1715092427131",
                        "type": "text",
                        "_input_fields": [
                            {
                                "id": "17150924288970.221334140441432443103302"
                            }
                        ],
                        "paraText": "AND",
                        "_conditionalView": true,
                        "_conditionalView_field": "step",
                        "_conditionalView_operator": "contains",
                        "_conditionalView_value": "1",
                        "_conditions": [
                            {
                                "id": "condition_1715094618811",
                                "_conditionalView_value": "1",
                                "_conditionalView_field": "FormState.cond1",
                                "_conditionalView_operator": "=="
                            },
                            {
                                "id": "condition_1715096851654",
                                "_conditionalView_field": "FormState.cond2",
                                "_conditionalView_operator": "==",
                                "_conditionalView_value": "1"
                            }
                        ],
                    ...
                    {
                        "id": "elmnt_1715096012215",
                        "type": "text",
                        "paraText": "OR",
                        "_conditionalView": true,
                        "_conditions": [
                            {
                                "id": "condition_1715096062366",
                                "_conditionalView_field": "FormState.cond1",
                                "_conditionalView_operator": "==",
                                "_conditionalView_value": "2"
                            },
                            {
                                "id": "condition_1715096165518",
                                "_conditionalView_field": "FormState.cond2",
                                "_conditionalView_operator": "!==",
                                "_conditionalView_value": "2"
                            }
