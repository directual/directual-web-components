...
let exampleForm = {
    ...
    "params": {
        "steps": [
            {
                ...
                "elements": [
                    {
                        "id": "elmnt_1717753261672",
                        "type": "input",
                        "_input_fields": [
                            {
                                "id": "17177532630840.13210010401413200121022",
                                "_field": "date"
                            },
                            {
                                "id": "17177533847460.14030130101231020023403",
                                "_field": "string"
                            }
                        ],
        ...
        "actions": [
            {
                "id": "action_1717684275152",
                "name": "button",
                "actionType": "state",
                "stateMapping": [
                    {
                        "id": "stateMapping1717684280985",
