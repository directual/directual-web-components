...
export function SetTheme({ themeName, onLoadComplete }) {
    ...
    const setTheme = ( theme ) => {
        ...
        document.documentElement.style.setProperty('--menu-font-weight', theme.menuFontWeight || 400)
        ...
        document.documentElement.style.setProperty('--menu-font-family', "'" + theme.menuText + "'" + ', sans-serif')
        ...
        document.documentElement.style.setProperty('--menu-font-size', theme.menuSize + 'px')
        ...
        document.documentElement.style.setProperty('--menu-font-style', theme.menuFontStyle)
