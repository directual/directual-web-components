...
import MainMenu, {
  NewMainMenu,
  NewMobileTabs
} from './components/fps/mainmenu/mainmenu'
...
import {
  ...
  ContentWrapper,
  ComponentWrapper
} from './components/fps/wrapper/wrapper'
import Input, {
  InputGroup,
  InputRow
} from './components/fps/dataentry/input/input'
...
import FileUpload, {
  DropFiles
} from './components/fps/dataentry/fileupload/fileupload'
import {
  SignIn,
  SignUp,
  Profile,
  RestorePass
} from './components/fps/profile/profile'
...
} from './components/fps/dataentry/optionsHandler/optionsHandler'
