...
const App = (props) => {
  ...
  let cardActions = {
    ...
    "params": {
      ...
      "data": {
        ...
        "fields": {
          ...
          "status": {
            "id": "status",
            "content": "Статус (suggested,new,approved,declined)",
            "type": "field",
            "dataType": "string",
            "format": "",
            "formatOptions": {},
    ...
    "tableTitle": "💎 Подходящие вакансии",
    "actions": null,
    "headers": [
      {
        "sysName": "date_created",
